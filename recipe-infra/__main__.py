...
# Read image config with defaults
cfg = pulumi.Config()
image_repo = cfg.get("imageRepo") or "ghcr.io/jamesbarber6406/recipe-site"
    ...
    spec={
        ...
        "template": {
            ...
            "spec": {
                "containers": [{
                    "name": "recipe-app",
                    "image": image,                # <- use config-driven image
...
# Exports
pulumi.export("image_used", image)
